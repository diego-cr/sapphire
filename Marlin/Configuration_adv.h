...
// LCD Print Progress options
  ...
  #if ANY(HAS_MARLINUI_U8GLIB, EXTENSIBLE_UI, HAS_MARLINUI_HD44780, IS_TFTGLCD_PANEL, IS_DWIN_MARLINUI, TFT_COLOR_UI)
...
//#define NO_VOLUMETRICS
  ...
  //#define VOLUMETRIC_EXTRUDER_LIMIT
     ...
     */
    #define DEFAULT_VOLUMETRIC_EXTRUDER_LIMIT 25.00      // (mm^3/sec)
  #endif
#endif
